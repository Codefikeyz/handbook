...
The current percentage of staked supply can be checked on the [Substrate UI](https://blocks.l1.media/?rpc=wss://rpc.l1.media#/legacy-staking) ([joyutils](https://apps.joyutils.org/?rpc=wss://rpc.joyutils.org#/staking), [polkadot-js](https://polkadot.js.org/apps/?rpc=wss%3A%2F%2Frpc.joystream.org#/legacy-staking)).
